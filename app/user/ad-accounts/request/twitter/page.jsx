...
export default function AdAccountTwitterRequestPage() {
  ...
  const handleSubscriptionSuccess = async (subscriptionForm) => {
    ...
    const checkoutPreview = {
      subscriptionName: 'Twitter (X) - Standard Ad Account',
      amount: '€175',
    };
    const flow = {
  ...
  const benefitsColumn1 = [
    "Expert Twitter Ads guidance (7+ years experience)",
    "No domain limit, run multiple campaigns.",
    "Full technical support for tracking & pixels.",
    "High stability with global reach.",
  ];

  const benefitsColumn2 = [
    "Top-ups within 15-20 minutes.",
  ...
  return (
    <div className="min-h-screen bg-[#0D1216] text-white p-6 md:p-10">
        ...
        <div className="p-8 md:p-12">
          <div className="flex flex-col items-center text-center mb-12">
            <div className="mb-6 scale-110">
              <div className="w-[88px] h-[88px] rounded-full bg-black border-[3px] border-white/20 shadow-lg flex items-center justify-center relative">
                <TwitterXIcon className="w-10 h-10" />
              </div>
            </div>
            <h2 className="text-[28px] font-bold mb-8">KAZAN Solutions Twitter AD Account Subscription</h2>
            ...
            <div className="w-full flex flex-col md:flex-row items-center gap-4 text-left mb-12">
              ...
              <div>
                ...
                <p className="text-gray-400 text-[14px]">We use top-tier Twitter Ads Agency Business Partners to ensure stability and fewer restrictions.</p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-[#151D24] border border-white/5 rounded-2xl p-8 flex items-center gap-6">
                <div>
                  ...
                  <div className="text-[28px] font-bold">€199</div>
                </div>
              </div>
              <div className="bg-[#151D24] border border-white/5 rounded-2xl p-8 flex items-center gap-6">
                <div>
                  <h4 className="text-[16px] text-gray-200 mb-2 font-medium">Top-Up Fee</h4>
                  <div className="text-[28px] font-bold">3%</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="text-center pb-12">
            <h3 className="text-[18px] font-bold mb-2">The Best Twitter Ad Accounts</h3>
            <p className="text-[14px] text-gray-400 mb-8">We Are the Most Affordable Provider For Twitter ad accounts.</p>
      ...
      <SubscriptionRequestModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} platform="Twitter" planName="Advertising Account" onSuccess={handleSubscriptionSuccess} />
