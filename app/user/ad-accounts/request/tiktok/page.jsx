...
export default function AdAccountTiktokRequestPage() {
  ...
  const handleSubscriptionSuccess = async (subscriptionForm) => {
    ...
    const checkoutPreview = {
      subscriptionName: 'TikTok - Standard Ad Account',
      amount: '€175',
    };
    const flow = {
  ...
  const benefitsColumn3 = [
    ...
    "Direct Intern TikTok Rep support.",
        ...
        <div className="p-8 md:p-12">
          ...
          <div className="flex flex-col items-center text-center mb-12">
            <div className="mb-6 scale-110">
              <div className="w-[88px] h-[88px] rounded-full bg-[#2A313C] border-[3px] border-[#3B424D] shadow-lg flex items-center justify-center relative shadow-[#2A313C]/50">
                <TikTokIcon className="w-10 h-10 w-[42px] h-[42px]" />
              </div>
            </div>
            <h2 className="text-[28px] font-bold mb-8">
              KAZAN Solutions TIKTOK AD Account Subscription
            </h2>
          ...
          <div className="text-center pb-12">
            <h3 className="text-[18px] font-bold mb-2">
              The Best TikTok Ad Accounts
            </h3>
            <p className="text-[14px] text-gray-400 mb-8">
              We Are the Most Affordable Provider For TikTok ad accounts.
            </p>
            <Button 
              onClick={() => setIsModalOpen(true)}
              className="bg-[#C5A964] hover:bg-[#D4BB7D] text-[#11191F] px-10 h-14 rounded-xl text-[18px] font-bold transition-all duration-300 shadow-lg shadow-[#C5A964]/10"
            >
              Subscribe
            </Button>
          </div>
