...
export default function AdAccountPinterestRequestPage() {
  ...
  const handleSubscriptionSuccess = async (subscriptionForm) => {
    ...
    const checkoutPreview = {
      subscriptionName: 'Pinterest - Standard Ad Account',
      amount: '€175',
    };
    const flow = {
  ...
  const benefitsColumn1 = [
    "Expert Pinterest Ads guidance (5+ years experience)",
    "No domain limit, run multiple shops.",
    "Full technical support for catalog & tagging.",
  ...
  const benefitsColumn3 = [
    "Unlimited ad spend.",
    "Direct rep support.",
    "Cleanest algorithm for conversion.",
  ...
  return (
    <div className="min-h-screen bg-[#0D1216] text-white p-6 md:p-10">
        ...
        <div className="p-8 md:p-12">
          <div className="flex flex-col items-center text-center mb-12">
            <div className="mb-6 scale-110">
              <div className="w-[88px] h-[88px] rounded-full bg-[#E60023]/10 border-[3px] border-[#E60023]/20 shadow-lg flex items-center justify-center relative">
                <PinterestIcon className="w-10 h-10" />
              </div>
            </div>
            <h2 className="text-[28px] font-bold mb-8">KAZAN Solutions Pinterest AD Account Subscription</h2>
            ...
            <div className="w-full flex flex-col md:flex-row items-center gap-4 text-left mb-12">
              ...
              <div>
                ...
                <p className="text-gray-400 text-[14px]">We use top-tier Pinterest Agency Business Partners to ensure stability and fewer restrictions.</p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-[#151D24] border border-white/5 rounded-2xl p-8 flex items-center gap-6">
                <div>
                  ...
                  <div className="text-[28px] font-bold">€150</div>
                </div>
              </div>
              <div className="bg-[#151D24] border border-white/5 rounded-2xl p-8 flex items-center gap-6">
                <div>
                  <h4 className="text-[16px] text-gray-200 mb-2 font-medium">Top-Up Fee</h4>
                  <div className="text-[28px] font-bold">2.5%</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="text-center pb-12">
            <h3 className="text-[18px] font-bold mb-2">The Best Pinterest Ad Accounts</h3>
            <p className="text-[14px] text-gray-400 mb-8">We Are the Most Affordable Provider For Pinterest ad accounts.</p>
      ...
      <SubscriptionRequestModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} platform="Pinterest" planName="Advertising Account" onSuccess={handleSubscriptionSuccess} />
