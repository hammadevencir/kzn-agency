...
export default function AdAccountTaboolaRequestPage() {
  ...
  const handleSubscriptionSuccess = async (subscriptionForm) => {
    ...
    const checkoutPreview = {
      subscriptionName: 'Taboola - Standard Ad Account',
      amount: '€175',
    };
    const flow = {
  ...
  const benefitsColumn1 = [
    "Native ads expert guidance (10+ years experience)",
    "No domain limit, scale multiple native offers.",
    "Full technical support for Taboola pixels.",
    "Unmatched stability for high volume.",
  ];

  const benefitsColumn2 = [
    "Top-ups within 20-30 minutes.",
    "Ad Account delivery within 24-72 hours.",
    "24/7 technical support.",
    "Higher content approvals.",
  ];

  const benefitsColumn3 = [
    "Unlimited monthly spend.",
    "Direct Taboola rep support.",
    "Best algorithm for Arbitrage.",
  ...
  return (
    <div className="min-h-screen bg-[#0D1216] text-white p-6 md:p-10">
        ...
        <div className="p-8 md:p-12">
          <div className="flex flex-col items-center text-center mb-12">
            <div className="mb-6 scale-110">
              <div className="w-[88px] h-[88px] rounded-full bg-[#0051FF]/10 border-[3px] border-[#0051FF]/20 shadow-lg flex items-center justify-center relative">
                <TaboolaIcon className="w-10 h-10" />
              </div>
            </div>
            <h2 className="text-[28px] font-bold mb-8">KAZAN Solutions Taboola AD Account Subscription</h2>
            ...
            <div className="w-full flex flex-col md:flex-row items-center gap-4 text-left mb-12">
              ...
              <div>
                ...
                <p className="text-gray-400 text-[14px]">We use top-tier Taboola Agency Partners to ensure stability and fewer restrictions.</p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-[#151D24] border border-white/5 rounded-2xl p-8 flex items-center gap-6">
                <div><h4 className="text-[16px] text-gray-200 mb-2 font-medium">Monthly Fee</h4><div className="text-[28px] font-bold">€250</div></div>
              </div>
              <div className="bg-[#151D24] border border-white/5 rounded-2xl p-8 flex items-center gap-6">
                <div><h4 className="text-[16px] text-gray-200 mb-2 font-medium">Top-Up Fee</h4><div className="text-[28px] font-bold">4.5%</div></div>
              </div>
            </div>
          </div>

          <div className="text-center pb-12">
            <h3 className="text-[18px] font-bold mb-2">The Best Taboola Ad Accounts</h3>
            <p className="text-[14px] text-gray-400 mb-8">We Are the Most Affordable Provider For Taboola ad accounts.</p>
      ...
      <SubscriptionRequestModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} platform="Taboola" planName="Advertising Account" onSuccess={handleSubscriptionSuccess} />
