...
const cfg = getPlatformRequestConfig('twitter');

export default function TwitterAgencyAccountPage() {
  ...
  const benefitsColumn3 = [
    ...
    "Direct Intern Twitter Rep support.",
  ...
  return (
    <div className="min-h-screen bg-[#0D1216] text-white p-6 md:p-10">
        ...
        <div className="p-8 md:p-12">
          ...
          <div className="flex flex-col items-center text-center mb-12">
            <div className="mb-6 scale-110">
              <div className="w-[88px] h-[88px] rounded-full bg-[#2A313C] border-[3px] border-[#3B424D] shadow-lg flex items-center justify-center relative shadow-[#2A313C]/50">
                <TwitterXIcon className="w-10 h-10 w-[42px] h-[42px]" />
              </div>
            </div>
            <h2 className="text-[28px] font-bold mb-8">
              KAZAN Solutions Twitter (X) AD Account Subscription
            </h2>
          ...
          <div className="mb-16">
            ...
            <p className="text-gray-400 text-[13px] mt-6">
              Minimum top-up for a Twitter (X) ad account is{' '}
          ...
          <div className="text-center">
            <h3 className="text-[18px] font-bold mb-2">
              The Best Twitter (X) Ad Accounts
            </h3>
            <p className="text-[14px] text-gray-400 mb-8">
              We Are the Most Affordable Provider For Twitter (X) ad accounts.
            </p>
            <Button 
      ...
      <SubscriptionRequestModal 
        ...
        platform="Twitter"
        planName="Twitter Agency Account"
        fields={cfg.fields}
